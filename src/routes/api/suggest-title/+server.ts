	...
	try {
		...
		const fixedMessages = [
			...
			...messages.slice(0, 3),
			{
				role: 'user',
				content:
					"Suggest a short title for this chat session,Remember this app is for education purposes so students are going to be using it. Title should be no more thatn 100 characters.. Take the 'system' message into account and the first prompt from me and your first answer. Don't use punctuation is the title."
